...
const WORDS = ["Computer Engineering Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Python", "Android"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/YUVRAJ007137" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/yuvraj-chaudhari-72a9072a0/" },
  { icon: Instagram, link: "https://www.instagram.com/yuvraj007c" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Enthusiastic and self-motivated with a strong foundation in software development, AI, and full-stack web development. 
                </p>
